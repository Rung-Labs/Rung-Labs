  ...
  constructor() {
    super({
      ...
      void main() {
        ...
        // Electric teal color with bright glow
        vec3 electricTeal = vec3(0.04, 0.88, 0.8); // rgba(11, 226, 204) normalized
        gl_FragColor = vec4(electricTeal * (0.8 + sparkleBrightness * 0.2), mix(alpha, sparkleBrightness - 1.1, uTransition));
      }`,
      uniforms: {
